...
function App() {
  ...
  if (inView) {
    setTimeout(() => {
      setLoading(false);
    }, 2000); // Détecte immédiatement si le contenu est visible
  }
          ...
          <header>
            ...
            <div className="accueil flex items-center justify-center flex-col gap-2 mt-16">
              ...
              <h1 className="font-bold text-3xl mt-14 backdrop-blur-sm p-2 text-[#0B3005]">
                Bienvenue sur{" "}
                <span className="text-[green-600]">E-Hoaniko,</span>{" "}
              </h1>
            ...
            <div className="grid grid-cols-3 gap-8 mt-11">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="right flex flex-col gap-4">
                  ...
                  <p>
                    Explorez nos produits frais et de qualité pour une
            ...
            <div className="fot-bg h-96 flex items-center justify-center relative">
              ...
              <div className="flex flex-col gap-4 items-center justify-center ">
                ...
                <p className="text-center w-5/12 m-auto">
                  ...
                  culinaire inoubliable avec nous. Explorez nos délicieuses
                  offres et laissez-vous séduire par notre passion pour la
                  gastronomie !
                </p>
